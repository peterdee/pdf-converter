...
var file_grpc_index_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x75, 0x69, 0x64, 0x32, 0xd0, 0x02, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x10, 0x5a, 0x0e, 0x67, 0x72, 0x70, 0x63,
...
var file_grpc_index_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_grpc_index_proto_depIdxs = []int32{
	...
	1, // 5: api.Converter.DeleteEntry:output_type -> api.DeleteEntryResponse
	3, // 6: api.Converter.DownloadArchive:output_type -> api.DownloadArchiveResponse
	5, // 7: api.Converter.GetInfo:output_type -> api.GetInfoResponse
	7, // 8: api.Converter.GetQueue:output_type -> api.GetQueueResponse
	9, // 9: api.Converter.QueueFile:output_type -> api.QueueFileResponse
